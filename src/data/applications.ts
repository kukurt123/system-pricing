    ...
    features: [
      {
        ...
        image: '/illustrations/core-system.svg',
        price: 30000,
      },
      {
        id: 'dual-station',
        ...
        image: '/illustrations/dual-station.svg',
        price: 12000,
      },
      {
        id: 'lab-scanning',
        ...
        image: '/illustrations/lab-scanning.svg',
        price: 4500,
      },
      {
        id: 'inventory',
        ...
        image: '/illustrations/inventory.svg',
        price: 10000,
      },
      {
        id: 'remote-encoding',
        name: 'Historical Record Encoding (Off-Site)',
        description: 'Encode old patient records on a separate computer outside the clinic and sync them into the main system.',
        highlights: [
          'Off-site or at-home encoding setup',
          'Designed for encoding historical and backlog records',
        ],
        image: '/illustrations/remote-encoding.svg',
        price: 8000,
      },
      {
        id: 'dashboard',
        ...
        highlights: [
          'Revenues and consultation counts',
          'Date-based filters',
      ...
      },
      {
        ...
        highlights: [
          'Guardian and birth detail fields',
          'Child-friendly forms',
          'Optimized pediatric workflow',
        ],
        image: '/illustrations/pediatrics-pack.svg',
        price: 5000,
      },
      {
        ...
        highlights: [
          'Clinic branding and layout',
          'Professional printouts',
          'Consistent document formats',
        ],
        image: '/illustrations/print-customization.svg',
        price: 4500,
      },
    ],
  },
